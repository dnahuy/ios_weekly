...
class BasicListViewController: UIViewController {
    ...
    let dataItems2 = [
        SFSymbolItem(name: "huy 1"),
        SFSymbolItem(name: "huy 2"),
        SFSymbolItem(name: "huy 3"),
        SFSymbolItem(name: "huy 4")
    ]
...
extension BasicListViewController: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        if indexPath.row == 0 {
            snapshot = NSDiffableDataSourceSnapshot<Section, SFSymbolItem>()
            snapshot.appendSections([.main, .huy])
            snapshot.appendItems(dataItems2, toSection: .main)
            snapshot.appendItems(dataItems, toSection: .main)
